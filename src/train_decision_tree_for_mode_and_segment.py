...
def run_for_mode_and_depth(df, mode, max_depth, segment_type):
    ...
    plots_dir = Path(f'/home/sagemaker-user/studio/src/new-rider-v3/plots/decision_tree/segment_{segment_type}/mode_{mode}/max_depth_{max_depth}')
    reports_dir = Path(f'/home/sagemaker-user/studio/src/new-rider-v3/reports/decision_tree/segment_{segment_type}/mode_{mode}/max_depth_{max_depth}')
...
def main(mode_list, max_depth_list, segment_type='all'):
    print(f"Training decision trees for segment: {segment_type}")
    ...
    print(f"  - Plots: /home/sagemaker-user/studio/src/new-rider-v3/plots/decision_tree/segment_{segment_type}/")
    print(f"  - Reports: /home/sagemaker-user/studio/src/new-rider-v3/reports/decision_tree/segment_{segment_type}/")
